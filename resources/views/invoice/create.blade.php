@extends('layouts.app', ['pageTitle' => trans('dam.invoice.new_incoming') ])
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    ...
                    <div class="field">
                        ...
                        {{ Form::select('customer_id', $customers, null, ['placeholder' => trans('dam.customer.customer')]) }}
                    </div>
                    <div class="field">
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    ...
                    <div class="field">
                        ...
                        {{ Form::text('invoice[due_date]', \Carbon\Carbon::now()->addWeek(4)->format('d-m-Y'), ['placeholder' => trans('dam.invoice.due_date'), 'class' => 'date']) }}
                    </div>
                    <div class="field">
                        {{ Form::label('invoice[number]', trans('dam.invoice.number')) }}
                        {{ Form::text('invoice[number]', null, ['placeholder' => trans('dam.invoice.number'), 'disabled' => 'disabled']) }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div id="specification">
                        <div class="row -no-gutter-hor -align-vert-center specification">
                            ...
                            <div class="col-8 field">{{ Form::select('items[0][project_id]', $projects, null, ['class' => 'projects']) }}</div>
                            ...
                            <div class="col-8 field">{{ Form::select('items[0][vat_rate]', $vat_rates, null, ['class' => 'vat_percentage']) }}</div>
