                    ...
                    <div class="list -striped">
                        <div class="list-item">
                            <div class="row -no-gutter">
                                ...
                                <div class="col-7 -align-right">&euro; {{ number_format($invoice->totals('sub'), 2, ',', '.') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="list-item">
                            <div class="row -no-gutter">
                                ...
                                <div class="col-7 -align-right"><strong>&euro; {{ number_format($invoice->totals('due'), 2, ',', '.') }}</strong></div>
                            </div>
                        </div>
                    </div>
                </div>
